...
public class FundingAndFdFile {
	private int fdFileCode;
	private int fileFdCode;
	private String fdFileName;
	private String fdFileUploadName;
	private String fdFileExtension;
	private int fdFileSize;
	...
	public String getFdFileUploadName() {
		return fdFileUploadName;
	}
	public void setFdFileUploadName(String fdFileUploadName) {
		this.fdFileUploadName = fdFileUploadName;
	}
	public int getFdFileCode() {
		return fdFileCode;
	}
	public void setFdFileCode(int fdFileCode) {
		this.fdFileCode = fdFileCode;
	}
	public int getFileFdCode() {
		return fileFdCode;
	}
	public void setFileFdCode(int fileFdCode) {
		this.fileFdCode = fileFdCode;
	}
	...
	public String getFdFileExtension() {
		return fdFileExtension;
	}
	public void setFdFileExtension(String fdFileExtension) {
		this.fdFileExtension = fdFileExtension;
	}
	public int getFdFileSize() {
		return fdFileSize;
	}
	public void setFdFileSize(int fdFileSize) {
		this.fdFileSize = fdFileSize;
	}
	@Override
	public String toString() {
		return "FundingAndFdFile [fdFileCode=" + fdFileCode + ", fileFdCode="
				+ fileFdCode + ", fdFileName=" + fdFileName
				+ ", fdFileUploadName=" + fdFileUploadName
				+ ", fdFileExtension=" + fdFileExtension + ", fdFileSize="
				+ fdFileSize + ", fdCode=" + fdCode + ", fdComCode=" + fdComCode
