...
public class DividendpayAndInvestment {
	...
	public String toString() {
		return "DividendpayAndInvestment [divPayCode=" + divPayCode
				+ ", divPayFdCode=" + divPayFdCode + ", divPayInvestCode="
				+ divPayInvestCode + ", divPayFdTitle=" + divPayFdTitle
				+ ", divPayAmount=" + divPayAmount + ", divPayDate="
				+ divPayDate + ", divPayissuePrice=" + divPayissuePrice
				+ ", divPayPurchaseShares=" + divPayPurchaseShares
				+ ", divPayNoShares=" + divPayNoShares
				+ ", divPayMinInterestRate=" + divPayMinInterestRate
				+ ", divPayDividendRate=" + divPayDividendRate
				+ ", divPayTotalMargin=" + divPayTotalMargin + ", investId="
				+ investId + "]";
	}
