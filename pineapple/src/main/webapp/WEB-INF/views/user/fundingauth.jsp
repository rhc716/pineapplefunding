...
<!-- 본문 -->
	<div class="row">
		...
		<br>
			<!-- 권한 부여자인 권한부여정보 조회 -->
			<c:choose>
				<c:when test="${rank eq '경영진' or authgiverList.authLevelName eq 'PM'}">
				...
				<c:otherwise>
					<div>
						<a type="button" class="btn btn-block btn-info disabled" data-toggle="modal" href="#newfdauthmodal">${nickname}님은 펀딩내 권한부여를 할 수 없습니다</a>
					</div>
				</c:otherwise>
			</c:choose>
			<!-- 권한 피부여자인 권한부여정보 조회 -->
