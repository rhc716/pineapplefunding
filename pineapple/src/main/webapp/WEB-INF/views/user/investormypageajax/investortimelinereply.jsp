		...
		<c:forEach var="Data" items="${timelinereplylist}">
			<div>
				<div class="col-xs-12">
					...
					<c:choose>
					<c:when test="${Data.tlReId == id}">
					<span class="timeline-replyupanddel">
						&nbsp;&nbsp;<a class="timelinereupdate" dataCode="${Data.tlReCode}">수정하기</a>
						&nbsp;&nbsp;<a href="/pineapple/investortimelinereplydelete.invest?tlReCode=${Data.tlReCode}">삭제하기</a>
					</span>
					</c:when>
					</c:choose>
				</div>
				...
				<div class="timeline-display" id="timelinereplyreload_${Data.tlReCode}">
					<form id="timelinereplyform${Data.tlReCode}" action="/pineapple/investortimelinereplyupdate.invest" method="post">
						<div class="col-xs-6">
