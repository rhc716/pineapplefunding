...
<!-- 경영진마이페이지 Tab bar -->
	<ul id="myTab" class="nav nav-tabs" role="tablist"> 
		...
		<li role="presentation" class="">
			<a href="#insertCompany" role="tab" id="insertCompany-tab" data-toggle="tab" aria-controls="insertCompany" aria-expanded="false">기업등록/삭제요청</a>
		</li>
		<li role="presentation" class="">
		...
		<li role="presentation" class="">
			<a href="#employeeList" role="tab" id="employeeList-tab" data-toggle="tab" aria-controls="employeeList" aria-expanded="false">사원리스트</a>
		</li>
		<li role="presentation" class="">
