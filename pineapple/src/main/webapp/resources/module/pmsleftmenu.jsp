...
<c:if test="${level eq '기업회원'}">
	<nav id="mysidebarmenu" class="amazonmenu">
		<ul>
			...
			<li><a href="">WBS관리</a>
				<ul>
					<li><a href="/pineapple/wbsplaninsertform.pms">WBS예상작성</a></li>
					<li><a href="/pineapple/wbsplanlistpage.pms">WBS관리</a></li>
					<li><a href="/pineapple/wbsactualinsertform.pms">WBS실제작성</a></li>
					<li><a href="/pineapple/wbsactuallistform.pms">WBS실제조회</a></li>
